...
describe("GameOfLife", () => {
    it("Should give the neighbours from position 00", () => {
        expect(Neighbours(tablero, 0, 0)).toEqual([1, 10, 11]);
    });
    it("Should give the neighbours from position 01", () => {
        expect(Neighbours(tablero, 0, 1)).toEqual([0, 2, 10, 11, 12]);
    });
    it("Should give the neighbours from position 02", () => {
        expect(Neighbours(tablero, 0, 2)).toEqual([1, 11, 12]);
    });
    it("Should give the neighbours from position 10", () => {
        expect(Neighbours(tablero, 1, 0)).toEqual([0, 1, 11, 20, 21]);
    });
    it("Should give the neighbours from position 11", () => {
        expect(Neighbours(tablero, 1, 1)).toEqual([0, 1, 2, 10, 12, 20, 21, 22]);
    });
    it("Should give the neighbours from position 12", () => {
        expect(Neighbours(tablero, 1, 2)).toEqual([1, 2, 11, 21, 22]);
    });
    it("Should give the neighbours from position 20", () => {
        expect(Neighbours(tablero, 2, 0)).toEqual([10, 11, 21]);
    });
    it("Should give the neighbours from position 21", () => {
        expect(Neighbours(tablero, 2, 1)).toEqual([10, 11, 12, 20, 22]);
    });
    it("Should give the neighbours from position 22", () => {
        expect(Neighbours(tablero, 2, 2)).toEqual([11, 12, 21]);
    });
    ...
    it("Should give the the next state for the position 11", () => {
        ...
        expect(StateNextGeneration(error, 1, 1)).toBe(false);
    });
